...
const quickActionsConfig: QuickActionGroup[] = [
  {
    ...
    title: "GENERAL",
    items: [
      { id: "add-customer", label: "Add New Customer", icon: UserPlus },
    ],
  },
  {
    id: "finance",
    title: "FINANCE",
    items: [
      { id: "add-deposit", label: "Add Deposit", icon: ArrowDownToLine },
      { id: "add-withdrawal", label: "Add Withdrawal", icon: ArrowUpFromLine },
    ],
  },
  {
    id: "manage",
    title: "MANAGE",
    items: [
      { id: "add-staff", label: "Add New Staff", icon: Users },
      { id: "account-type", label: "Account Type", icon: CreditCard },
      { id: "deposit-method", label: "Deposit Method", icon: ArrowDownToLine },
      { id: "withdrawal-method", label: "Withdrawal Method", icon: Wallet },
    ],
  },
];
