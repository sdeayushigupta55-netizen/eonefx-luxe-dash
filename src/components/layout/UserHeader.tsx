...
export function UserHeader({ onOpenRiskHub, customerName: propCustomerName }: UserHeaderProps) {
    ...
    <>
      <header className="sticky top-0 z-30 flex h-14 sm:h-16 items-center justify-between border-b border-border bg-card px-3 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <h1 className="text-base sm:text-lg font-semibold text-foreground">{customerName}</h1><X className="h-5 w-5 bg-red-500 rounded-lg p-1"/>
        </div>
