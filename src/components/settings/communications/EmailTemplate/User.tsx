...
export default function User() {
    ...
    const emailTemplates: EmailTemplate[] = [
        ...
        {
            id: 5,
            title: "User Deposit Success",
            category: "User",
            status: "active",
        },
        {
            id: 6,
            title: "User Withdrawal Success",
            category: "User",
            status: "active",
        },
        {
            id: 7,
            title: "User Deposit Failed",
            category: "User",
            status: "active",
        },
        {
            id: 8,
            title: "User Withdrawal Failed",
            category: "User",
            status: "active",
        },
        {
            id: 9,
            title: "User Balance Update Notification",
            category: "User",
            status: "active",
        },
        {
    ...
    const handleEditClick = (template: EmailTemplate) => {
        ...
        setMessageBody("Dear [[user_name]], this is a notification regarding your account.");
        setButtonLabel("View Account");
        setButtonLink("[[token]]");
                ...
                <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-2 sm:p-4">
                    <div className="w-full max-w-[95vw] h-[95vh] bg-card rounded-lg shadow-card overflow-hidden flex flex-col">
                        <div className="flex justify-between items-center px-4 sm:px-6 py-3 sm:py-4 border-b border-border flex-shrink-0">
                            <h2 className="text-lg sm:text-xl font-semibold">Edit Auto Deposit Failed Template</h2>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="w-full lg:w-80 flex-shrink-0">
                                    <div className="bg-muted/30 rounded-lg p-4 sticky top-0">
                                        ...
                                        <p className="text-xs text-muted-foreground mb-4 flex items-center gap-2">
                                           ...
                                           The Shortcuts you can use [[full_name]], [[txn]], [[method]], [[amount]], [[description]], [[date]], [[site_title]], [[site_url]], [[deposit_amount]], [[gateway_name]], [[message]]
                                        </p>

                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Full Name:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[full_name]]
                                                    <button
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Txn:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[txn]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                                        onClick={() => navigator.clipboard.writeText("[[txn]]")}
                                                    >
                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                        </svg>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Method:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[method]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                                        onClick={() => navigator.clipboard.writeText("[[method]]")}
                                                    >
                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                        </svg>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Amount:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[amount]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Description:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[description]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Date:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[date]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Deposit Amount:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[deposit_amount]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                                        onClick={() => navigator.clipboard.writeText("[[deposit_amount]]")}
                                                    >
                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                        </svg>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Gateway Name:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[gateway_name]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
                                                        onClick={() => navigator.clipboard.writeText("[[gateway_name]]")}
                                                    >
                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                        </svg>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="text-xs font-medium min-w-[100px]">Message:</div>
                                                <div className="bg-background rounded px-2 py-1 text-xs font-mono border border-border flex items-center justify-between flex-1">
                                                    [[message]]
                                                    <button
                                                        className="ml-2 text-muted-foreground hover:text-foreground"
