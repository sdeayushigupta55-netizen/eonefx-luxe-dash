...
export default function User() {
    ...
    const smsTemplates: SmsTemplate[] = [
        ...
        {
            id: 6,
            title: "Manual Deposit Request Action",
            category: "User",
            status: "active",
        },
        {
    ...
    const handleEditClick = (template: SmsTemplate) => {
        ...
        setMessageBody("Hello! [[txn]]. 'Successfully Investment [[plan_name]] [[invest_amount]] [[roi]]");
                        ...
                        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
                            <div className="space-y-6">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    The Shortcuts you can use <span className="font-mono">[[full_name]], [[txn]], [[plan_name]], [[invest_amount]], [[roi]], [[site_title]], [[site_url]]</span>
                                </p>
