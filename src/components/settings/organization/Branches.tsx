...
export default function Branches() {
  const [branches, setBranches] = useState<Branch[]>([
    ...
    { name: "Test", code: "UK", users: 2, staff: 1, isActive: true },
  ]);
  ...
  const handleAddBranch = () => {
    ...
    const newBranch: Branch = { name: branchName, code: branchCode, users: 0, staff: 0, isActive };
  ...
  const handleUpdateBranch = () => {
    ...
    if (editIndex !== null) {
      ...
      updatedBranches[editIndex] = { ...updatedBranches[editIndex], name: branchName, code: branchCode, isActive };
