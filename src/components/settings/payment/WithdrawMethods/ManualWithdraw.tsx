...
const initialMethods = [
    { provider: "Bank Transfer - PKR", logo: "https://demo.brokeret.com/assets/global/images/CFHcj4dqNVEXZcQoa2F7.png", title: "Bank Transfer - PKR", status: "Active", processing: "Manual Approval", fee: "0", limits: "10 - USD", branches: "N/A" },
];
...
export default function ManualWithdraw({ openAddIntent, onAddIntentConsumed }: Props) {
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <StatusToggle
                                            ...
                                            tooltip="Enable to set manually coversion rate"
                                        />
                                    ...
                                    <InputField
                                        ...
                                        tooltip="Define the conversion from 1 AUD to the target currency"
                                        prefix="1 USD ="
                                        suffix="USD"
                                    />
                                    ...
                                    <InputField
                                        ...
                                        onChange={handleInputChange}
                                        placeholder="5"
                                        tooltip="The minimum withdraw allowed using this method"
                                        suffix="USD"
                                    />
                                    ...
                                    <InputField
                                        ...
                                        tooltip="Estimated time to process a withdraw using this method"
                                    />
                                    ...
                                    <StatusToggle
                                        ...
                                        tooltip="Toggle to enable or disable the method for users"
                                    />
                                    ...
                                    <StatusToggle
                                        ...
                                        tooltip="Enable this to restrict the method to only users with no branch or specifically assigned branches"
                                    />
                                     <div className="col-span-2">
