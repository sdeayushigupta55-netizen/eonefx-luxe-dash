        ...
        <Card className="shadow-card border border-border bg-card max-w-md">
          <CardContent className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg font-semibold">Admin Auth Logo</h2>
              <Switch 
                checked={isEnabled} 
            ...
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Info size={16} className="curson-pointer" />
                </TooltipTrigger>
                <TooltipContent>
                  <p>Upload a logo to display in the admin login page footer</p>
                </TooltipContent>
              </Tooltip>
            </div>
