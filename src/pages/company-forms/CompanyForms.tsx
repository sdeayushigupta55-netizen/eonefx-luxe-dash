...
const formTabs = [
  { id: "pending", label: "Pending", path: "/company-forms/pending" },
  { id: "approved", label: "Approved", path: "/company-forms/approved" },
  { id: "rejected", label: "Rejected", path: "/company-forms/rejected" },
];
...
const mockData: Record<string, Array<{
  ...
  approved: [
    {
      id: "1",
      date: "2025-11-06 20:37",
      userName: "Richi Rj",
      userEmail: "hiphaven6@gmail.com",
      status: "Approved",
    },
  ],
  rejected: [],
...
function getStatusTitle(tabId: string) {
  switch (tabId) {
    case "pending":
      return "Pending Company Form Submissions";
    case "approved":
      return "Approved Company Form Submissions";
    case "rejected":
      return "Rejected Company Form Submissions";
    default:
      return "Company Form Submissions";
  }
}
