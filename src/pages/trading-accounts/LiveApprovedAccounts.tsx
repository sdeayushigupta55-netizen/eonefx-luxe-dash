...
const approvedAccounts: TradingAccount[] = [
  {
    id: '1',
    accountNumber: '878859',
    user: { name: 'Test New', email: 'richirj43743@gmail.com' },
    ...
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Dec 17, 2025 09:52',
  },
  {
    id: '2',
    accountNumber: '878816',
    user: { name: 'Test New', email: 'richirj43743@gmail.com' },
    accountType: 'Standard',
    group: 'Real|Test1',
    leverage: 100,
    ...
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Dec 04, 2025 12:49',
  },
  {
    id: '3',
    accountNumber: '878774',
    ...
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Nov 21, 2025 10:45',
  },
  {
    id: '4',
    accountNumber: '878686',
    user: { name: 'Racheal R', email: 'rachealjameel@gmail.com' },
    accountType: 'Standard',
    group: 'Real|Test1',
    leverage: 300,
    balance: '0.00 USD',
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Oct 27, 2025 07:54',
  },
  {
    id: '5',
    accountNumber: '878647',
    user: { name: 'User Brokeret', email: 'user@brokeret.com' },
    accountType: 'Standard',
    group: 'Real|Test1',
    leverage: 100,
    balance: '0.00 USD',
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Oct 21, 2025 08:53',
  },
  {
    id: '6',
    accountNumber: '878550',
    user: { name: 'Racheal R', email: 'rachealjameel@gmail.com' },
    accountType: 'Standard',
    group: 'Real|Test1',
    leverage: 100,
    ...
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Oct 03, 2025 09:01',
  },
  {
    id: '7',
    accountNumber: '878482',
    user: { name: 'User Brokeret', email: 'user@brokeret.com' },
    accountType: 'Standard',
    group: 'Real|Test1',
    leverage: 100,
    ...
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Sep 16, 2025 08:59',
  },
  {
    id: '8',
    accountNumber: '874641',
    user: { name: 'Sufyan Aslam', email: 'sufyanhashmi931@gmail.com' },
    accountType: 'Standard',
    group: 'Real|Test\\1',
    leverage: 100,
    balance: '93,763.11 USD',
    agentIBNumber: 'NA',
    status: 'Active',
    createdAt: 'Jul 23, 2025 05:26',
  },
];

const statCards = [
  { label: 'Total Accounts', value: '8', icon: CreditCard },
  { label: 'With Balance', value: '3', icon: CreditCard },
  { label: 'With Bonus', value: '0', icon: CreditCard },
  { label: 'Without Balance', value: '4', icon: CreditCard },
  { label: 'Without Bonus', value: '0', icon: CreditCard },
  { label: 'Inactive Accounts', value: '0', icon: CheckCircle },
];

const LiveApprovedAccounts: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Page Title */}
        <h1 className="text-2xl font-semibold text-foreground">All Approved Real Accounts</h1>
...
export default LiveApprovedAccounts;
