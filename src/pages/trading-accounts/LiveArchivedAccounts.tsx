...
const LiveArchivedAccounts: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Page Title */}
        <h1 className="text-2xl font-semibold text-foreground">All Archived Real Accounts</h1>
...
export default LiveArchivedAccounts;
