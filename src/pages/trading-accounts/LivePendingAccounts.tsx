...
const pendingAccounts: TradingAccount[] = [];

const LivePendingAccounts: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Page Title */}
        <h1 className="text-2xl font-semibold text-foreground">All Pending Real Accounts</h1>
...
export default LivePendingAccounts;
