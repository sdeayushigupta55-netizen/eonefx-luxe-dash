import { Users, ArrowRight, Edit, Mail, CheckCircle, Clock, ArrowDownToLine } from "lucide-react";
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 px-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Wallet</th>
          ...
          <tbody>
            <tr className="border-b border-border/50 hover:bg-muted/30 transition-colors">
              ...
              <td className="py-4 px-2 text-foreground text-sm">Bank Transfer - AED</td>
