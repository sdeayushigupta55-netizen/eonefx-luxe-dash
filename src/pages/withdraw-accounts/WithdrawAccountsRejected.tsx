...
const rejectedAccounts: WithdrawAccount[] = [
  {
    id: "1",
    date: "2025-09-23 23:18:43",
...
const WithdrawAccountsRejected = () => {
  ...
  const handleViewAction = (account: WithdrawAccount) => {
    ...
    setDescription("We were unable to approve your payout account. Please review the account information and resubmit, or contact support for guidance.");
    setIsModalOpen(true);
  };
        ...
        <div className="bg-card rounded-xl border border-border overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-border">
            <span className="text-sm text-muted-foreground">
              Showing 1 to {rejectedAccounts.length} of {rejectedAccounts.length} entries
            </span>
            <div className="flex items-center gap-2">
...
export default WithdrawAccountsRejected;