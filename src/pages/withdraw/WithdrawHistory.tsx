...
const withdrawHistory = [
  { id: 1, date: "Dec 17, 2025 11:49", user: "Racheal R", email: "rachealjameel@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRXORBMIOOMKI", account: "3394695823", amount: "-10 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Cancelled" },
  { id: 2, date: "Sep 23, 2025 11:28", user: "Racheal R", email: "rachealjameel@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRXPKQFWTTPFJ", account: "3394695823", amount: "-10 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Pending" },
  { id: 3, date: "Sep 15, 2025 02:26", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Test-1", transactionId: "TRX3HYLDZ5MFG", account: "5267185332", amount: "-20 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Pending" },
  { id: 4, date: "Sep 09, 2025 09:56", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRXNT7S9SEAOS", account: "5267185332", amount: "-20 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Pending" },
  { id: 5, date: "Sep 04, 2025 06:42", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRXLOXPVOVMAY", account: "5267185332", amount: "-20 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Cancelled" },
  { id: 6, date: "Aug 29, 2025 11:23", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRX9S22KTCGQ2", account: "874641", amount: "-20 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Success" },
  { id: 7, date: "Aug 29, 2025 11:11", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRXRX2ODCJTKF", account: "874641", amount: "-11 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Success" },
  { id: 8, date: "Aug 29, 2025 11:07", user: "Sufyan Aslam", email: "sufyanhashmi931@gmail.com", detail: "Withdraw With Bank Transfer - PKR", transactionId: "TRX4DEJNY7BTJ", account: "874641", amount: "-20 USD", charge: "1 USD", gateway: "Bank Transfer - PKR", status: "Cancelled" },
];
...
export default function WithdrawHistory() {
  ...
  const getTabTitle = (tabId: string) => withdrawTabs.find(t => t.id === tabId)?.label || "Withdraw History";
      ...
      <div className="p-6">
        ...
        <div className="bg-card rounded-xl border border-border overflow-hidden">
                ...
                {withdrawHistory.length === 0 ? (
                  ...
                  withdrawHistory.map((withdraw) => (
                    <tr key={withdraw.id} className="border-b border-border/50 hover:bg-muted/30">
                      ...
                      <td className="py-4 px-4">
                        <span className={cn("px-2 py-1 rounded text-xs font-medium", getStatusColor(withdraw.status))}>
                          {withdraw.status}
                        </span>
                      </td>
                      <td className="py-4 px-4">
          ...
          <div className="flex items-center justify-between px-4 py-4 border-t border-border">
            <p className="text-sm text-muted-foreground">Showing 1 to {withdrawHistory.length} of {withdrawHistory.length} entries</p>
